    ...
    <div className="bg-[#14532D]">
      <div className="min-h-screen w-11/12 mx-auto flex justify-center items-center">
        <div className="flex justify-between items-center w-full flex-col lg:flex-row-reverse py-4 gap-4">
          <div className="bg-[#c1e2be4e] rounded-4xl animate__animated animate__slideInRight  transition-all duration-300 hover:-translate-y-1">
            <Image
              src={image1}
              width={400}
              height={400}
          ...
          <div className="space-y-6 animate__animated animate__lightSpeedInLeft animate__slow ">
            ...
            <Link href={"/allAnimal"}>
              <button className="btn bg-yellow-400 shadow-none  transition-all duration-300 hover:-translate-y-1 ">
                Browse Animals
              </button>
            </Link>
          </div>
